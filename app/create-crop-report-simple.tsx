...
export default function CreateCropReportSimpleScreen() {
  ...
  const handleSubmit = async () => {
    console.log('=== SIMPLE CROP REPORT CREATION ===');
  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.title}>Create Crop Report (Simple)</Text>
      </View>
      ...
      <View style={styles.buttonContainer}>
        ...
        <Button
          ...
          onPress={() => {
            ...
            console.log('CROP_REPORTS_BASE:', CROP_REPORTS_BASE);
            Alert.alert('Debug', `API: ${getApiBaseUrl()}`);
          }}
